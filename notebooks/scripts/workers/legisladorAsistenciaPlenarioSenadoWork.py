...
from utils import get_html, find, find_all, find_all_class, extract_html_date, extract_html_int, find_class
from workers.workerScrap import WorkerScrap


class LegisladorAsistenciaPlenarioSenadoWork(WorkerScrap):
