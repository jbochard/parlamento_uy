...
from scripts.workers.legisladorAsistenciaComisionesWork import LegisladorAsistenciaComisionesWorker
from scripts.workers.senadoresAsistenciaPlenarioWork import SenadoresAsistenciaPlenarioWorker
from scripts.workers.proyectoWork import ProyectoWorker
