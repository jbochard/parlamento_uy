...
from scripts.utils import get_html, find, find_all, extract_html_date, extract_html_int, find_class
from scripts.workers.workerScrap import WorkerScrap


class RepresentantesAsistenciaPlenarioWorker(WorkerScrap):
